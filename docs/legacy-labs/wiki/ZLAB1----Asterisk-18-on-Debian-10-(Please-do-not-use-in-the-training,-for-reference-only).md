...
Step 1: Install Debian 10 Server in a virtual machine (you may use 32 or 64bits), for the examples I have used the 32 bit version. We have used Virtual Box for this training.
...
`cd asterisk-18-<complete_with_the_name_where_asterisk_was_decompressed>`\
