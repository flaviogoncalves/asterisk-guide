...
`exten=>6000,1,Dial(SIP/phone1)`\
`exten=>6001,1,Dial(SIP/phone2)`
...
`exten=>9999,n,waitexten(10)`\
`exten=>9999,n,Dial(${OPERATOR})`\
`exten=>1,1,dial(SIP/phone1)`\
`exten=>2,1,dial(SIP/phone2)`\
`exten=>3,1,dial(IAX/phone1)`\
`exten=>6000,1,Dial(SIP/phone1)`\
`exten=>6001,1,Dial(SIP/phone2)`
...
`[default]`\
`6000=>6000,phone1,root@localhost,,|attach=yes|delete=0`\
`6001=>6001,phone2, root@localhost,,|attach=yes|delete=0`
...
`[from-internal]`\
`exten=>6000,1,Gosub(stdexten,s,1(SIP/phone1,${EXTEN}))`\
`exten=>6001,1,Gosub(stdexten,s,1(SIP/phone2,${EXTEN}))`\
