...
पहले अध्याय में, हमने टेलीफोनी वातावरण में Asterisk की उपयोगिता के बारे में थोड़ा सीखा। इस अध्याय में, हम Asterisk को डाउनलोड और इंस्टॉल करने का तरीका जानेंगे। शुरू करने से पहले, इसे कंपाइल और इंस्टॉल करना सीखना आवश्यक है। कंपाइलेशन की प्रक्रिया पारंपरिक Microsoft™ Windows™ उपयोगकर्ताओं के लिए अजीब लग सकती है, लेकिन Linux™ वातावरण में यह काफी सामान्य है। Asterisk को कंपाइल करते समय आप अपने हार्डवेयर के लिए अनुकूलित (optimized) कोड प्राप्त कर सकते हैं, और हम यहाँ यही करेंगे। Asterisk कई ऑपरेटिंग सिस्टम पर चलता है, लेकिन हमने चीजों को आसान रखने के लिए उनमें से केवल एक के साथ शुरुआत करने का निर्णय लिया है: Linux। हमने Linux™ वितरण के रूप में Debian को चुना है क्योंकि इसकी निर्भरताएँ (dependencies) इंस्टॉल करना आसान है और यह वितरण स्थिर है, साथ ही इसका फुटप्रिंट भी कम है। यदि आप किसी अन्य वितरण का उपयोग करना चाहते हैं, तो कृपया निर्भरताओं के नाम तदनुसार बदल लें।

यह संस्करण **Asterisk 22 LTS** (16-10-2024 को जारी; 16-10-2028 तक पूर्ण समर्थन, 16-10-2029 तक सुरक्षा सुधार) को लक्षित करता है। Asterisk 22 वर्तमान लॉन्ग-टर्म सपोर्ट रिलीज़ है। ध्यान दें कि Digium का अधिग्रहण 2018 में **Sangoma** द्वारा किया गया था, और Asterisk अब Sangoma द्वारा प्रायोजित है — इस पूरे अध्याय में "Digium" के संदर्भ विरासत हार्डवेयर के लिए पुराने ब्रांड को दर्शाते हैं।
...
- आवश्यक निर्भरताओं के साथ Linux इंस्टॉल करना;
...
Asterisk को चलाने के लिए बहुत अधिक हार्डवेयर की आवश्यकता नहीं होती है, हालाँकि आपकी आवश्यकताओं के लिए सर्वोत्तम हार्डवेयर चुनने के लिए कुछ सुझाव दिए गए हैं। हार्डवेयर चुनते समय आपको निम्नलिखित मुख्य कारकों पर विचार करना चाहिए:

- पंजीकृत उपयोगकर्ताओं की कुल संख्या। यह निर्धारित करें कि आपको प्रति सेकंड कितने पंजीकरणों का समर्थन करने की आवश्यकता है।
- एक साथ होने वाली कॉल्स की कुल संख्या। यह निर्धारित करें कि आपको Asterisk सर्वर पर नेटवर्क एडेप्टर और ब्रिज में कितनी नेटवर्क वार्तालापों को प्रोसेस करने की आवश्यकता है।
- आपको किन codecs का समर्थन करने की आवश्यकता है। उच्च जटिलता वाले codecs को आपके सर्वर में बहुत अधिक CPU/FPU शक्ति की आवश्यकता होगी; उदाहरण के लिए, iLBC को इसके निर्माता (Global IP Sound) द्वारा TI C54x DSP पर 30 ms फ्रेम के लिए लगभग 18 MIPS (और 20 ms फ्रेम के लिए लगभग 15 MIPS) मापा गया था।
- इको कैंसलेशन। इको कैंसलेशन में बहुत अधिक CPU/FPU लग सकता है, कुछ मामलों में आपको टेलीफोनी इंटरफेस कार्ड में DSP का उपयोग करके हार्डवेयर इको कैंसलेशन चुनना चाहिए।
- उपलब्धता। उपलब्धता बढ़ाने के लिए RAID1 या 5 का उपयोग करें। याद रखें, Asterisk एक 24x7 एप्लिकेशन है।

Asterisk सर्वर के लिए मुख्य घटक नेटवर्क एडेप्टर है। एक अच्छे सर्वर नेटवर्क एडेप्टर की सिफारिश की जाती है। जब आपको g.729 और iLBC जैसे उच्च जटिलता वाले codecs और इको कैंसलेशन का समर्थन करने की आवश्यकता होती है, तो CPU महत्वपूर्ण होता है। आप समर्पित DSP का उपयोग करना चुन सकते हैं, Sangoma (पूर्व में Digium) TC400B नामक एक DSP कार्ड प्रदान करता है जो 120 g729 एक साथ कॉल्स का समर्थन करने में सक्षम है। सबसे अच्छा अभ्यास किसी ज्ञात निर्माता से एक नया, सर्वर-क्लास कंप्यूटर चुनना है। यह जानने के लिए कि कोई विशिष्ट मशीन वास्तव में कितनी एक साथ कॉल्स या कितने पंजीकृत उपयोगकर्ताओं का समर्थन कर सकती है, आपको SIPP (http://sipp.sourceforge.net) जैसे स्ट्रेस टेस्ट टूल के साथ इस हार्डवेयर का परीक्षण करना चाहिए। Xorcom (http://www.xorcom.com) जैसे कुछ हार्डवेयर निर्माता अपनी वेबसाइट पर परिणाम प्रकाशित करते हैं। नोट: कुछ Asterisk एप्लिकेशन, जैसे ConfBridge और music on hold, को एक आंतरिक टाइमिंग स्रोत की आवश्यकता होती है। आधुनिक Linux पर यह स्वचालित रूप से इन-बिल्ट `res_timing_timerfd` मॉड्यूल द्वारा प्रदान किया जाता है — किसी टेलीफोनी हार्डवेयर की आवश्यकता नहीं है। (पुराना `dahdi_dummy` सॉफ्टवेयर टाइमर अब मौजूद नहीं है; इसकी कार्यक्षमता DAHDI Linux 2.3.0 में मुख्य `dahdi` कर्नेल मॉड्यूल में शामिल कर दी गई थी।) आप CLI कमांड `timing test` के साथ सक्रिय टाइमर की पुष्टि कर सकते हैं।
...
- यदि आप टेलीफोनी इंटरफेस कार्ड का उपयोग कर रहे हैं तो विशेष ध्यान रखें। कुछ कार्ड 3.3 वोल्ट PCI बस का उपयोग करते हैं, और उनके लिए मदरबोर्ड ढूंढना आसान नहीं है। आजकल, PCI express अधिक आसानी से मिल जाता है।
...
टेलीफोनी इंटरफेस कार्ड (जैसे, X100P) बड़ी मात्रा में इंटरप्शन उत्पन्न करते हैं। इन इंटरप्शन को पूरा करने के लिए प्रोसेसर समय की आवश्यकता होती है। यदि आपके पास कोई अन्य डिवाइस उसी इंटरप्शन का उपयोग कर रहा है तो ड्राइवर यह प्रोसेसिंग नहीं कर सकते हैं। एक सिंगल CPU सिस्टम में, आपको डिवाइसों के बीच IRQ शेयरिंग से बचना चाहिए। हम Asterisk चलाने के लिए समर्पित हार्डवेयर के उपयोग की सलाह देते हैं। किसी भी बाहरी या अनावश्यक हार्डवेयर को अक्षम करना न भूलें। कुछ हार्डवेयर को मदरबोर्ड BIOS सेटअप में अक्षम किया जा सकता है। एक बार जब आप अपना कंप्यूटर शुरू कर लेते हैं, तो /proc/interrupts में अपने असाइन किए गए इंटरप्ट्स देखें।
...
अपना Linux सामान्य रूप से इंस्टॉल करें, बिना ग्राफिकल यूजर इंटरफेस के। ईमेल सर्वर को भी इंस्टॉल और कॉन्फ़िगर करें। हमें इस पुस्तक में बाद में वॉइसमेल नोटिफिकेशन भेजने के लिए ईमेल सर्वर (exim4) की आवश्यकता होगी। सावधानी: यह इंस्टॉलेशन आपके PC को फॉर्मेट कर देगा। आपका सारा डिस्क डेटा मिटा दिया जाएगा। कृपया शुरू करने से पहले सभी डेटा का बैकअप लेना सुनिश्चित करें। चरण 1: CD को CD-ROM ड्राइव में डालें और अपना PC बूट करें। अधिकांश प्रश्नों के उत्तर देना बहुत सरल है।

## निर्भरताएँ (dependencies) इंस्टॉल करना

Asterisk और DAHDI इंस्टॉल करने के लिए आपको कई सॉफ्टवेयर निर्भरताएँ इंस्टॉल करनी होंगी। Asterisk 22 में ऐसा करने का अनुशंसित तरीका सोर्स ट्री के साथ आने वाली स्क्रिप्ट का उपयोग करना है, जो प्रत्येक समर्थित वितरण के लिए सही पैकेज नाम जानती है। Asterisk सोर्स को डाउनलोड और एक्सट्रैक्ट करने के बाद (नीचे "Asterisk को कंपाइल करना" देखें), चलाएँ:
...
चरण 1: root के रूप में लॉगिन करें (या `sudo` का उपयोग करें)। चरण 2: यदि आप Debian/Ubuntu सिस्टम पर मैन्युअल रूप से निर्भरताएँ इंस्टॉल करना पसंद करते हैं, तो समकक्ष पैकेज सूची है:
...
ध्यान दें कि Asterisk सोर्स अब Git पर होस्ट किया गया है, इसलिए `subversion` की अब आवश्यकता नहीं है, और आधुनिक Debian/Ubuntu संस्करण वाले `libncurses5-dev` के बजाय `libncurses-dev` भेजते हैं। हाथ से बनाए गए सूची के बजाय `./contrib/scripts/install_prereq install` को प्राथमिकता दें, क्योंकि स्क्रिप्ट हमेशा आपके वितरण के लिए सही पैकेज नामों को ट्रैक करती है।

### DAHDI

DAHDI (Digium/Sangoma Asterisk Hardware Device Interface) एनालॉग और डिजिटल कार्ड के लिए ड्राइवरों का आर्किटेक्चर है। Asterisk इंस्टॉल करने से पहले, यदि आप एनालॉग या डिजिटल इंटरफेस का उपयोग करने की योजना बना रहे हैं, तो DAHDI इंस्टॉल करना महत्वपूर्ण है। DAHDI अभी भी एनालॉग/डिजिटल टेलीफोनी कार्ड के लिए मौजूद है लेकिन तेजी से विशिष्ट होता जा रहा है — अधिकांश आधुनिक परिनियोजन पूरी तरह से VoIP हैं और इस अनुभाग को पूरी तरह से छोड़ सकते हैं। DAHDI केवल तभी इंस्टॉल करें यदि आपके पास भौतिक टेलीफोनी इंटरफेस हार्डवेयर है। सोर्स फ़ाइलें प्राप्त करें:
...
make install-config DAHDI को कॉन्फ़िगर कर दिया गया है। यदि आपके पास कोई DAHDI हार्डवेयर है, तो अब यह अनुशंसा की जाती है कि आप /etc/dahdi/modules को संपादित करें ताकि केवल इस सिस्टम में इंस्टॉल किए गए DAHDI हार्डवेयर के लिए समर्थन लोड हो सके। डिफ़ॉल्ट रूप से सभी DAHDI हार्डवेयर के लिए समर्थन DAHDI स्टार्ट पर लोड किया जाता है। मुझे लगता है कि आपके सिस्टम पर जो DAHDI हार्डवेयर है वह है: usb:004/002 xpp_usb- e4e4:1150 Astribank-multi no-firmware यह स्क्रीन (ऊपर) आपसे फ़ाइल /etc/dahdi/modules को बदलने के लिए कहती है ताकि केवल आपके विशिष्ट कॉन्फ़िगरेशन के लिए आवश्यक ड्राइवर लोड हों और पता चला हार्डवेयर दिखाई दे। फ़ाइल /etc/dahdi/modules को संपादित करें और केवल आवश्यक हार्डवेयर लोड करें। मेरे मामले में, मैं Xorcom Astribank 6FXS और 2FXO के साथ एक परीक्षण मशीन का उपयोग कर रहा था। फ़ाइल नीचे दिखाई गई है।
...
अपने कंप्यूटर को पुन: प्रारंभ करें और ड्राइवरों के सही लोडिंग को सत्यापित करें।

## कौन सा संस्करण चुनें

अंगूठे के नियम के रूप में, आपको आवश्यक सुविधाओं वाले संस्करण का उपयोग करना चाहिए। Asterisk वैकल्पिक LTS (लॉन्ग-टर्म सपोर्ट) और मानक रिलीज़ के रिलीज़ मॉडल का पालन करता है। इस संस्करण के समय, **Asterisk 22 वर्तमान LTS रिलीज़ है** (अक्टूबर 2024 में जारी; नवीनतम पॉइंट रिलीज़ 22.10.0 है), जो इसे अभी चुनने के लिए सबसे अच्छा बनाता है। Asterisk 20 पिछला LTS है, और संस्करण 16 (पहले संस्करण में उपयोग किया गया) का जीवनकाल समाप्त हो चुका है। प्रोडक्शन सिस्टम के लिए, हमेशा LTS रिलीज़ चुनें।

> **[दूसरा संस्करण नोट]** लेखक/प्रिंट-समय जांच केवल: downloads.asterisk.org पर नवीनतम 22.x पॉइंट रिलीज़ की पुष्टि करें और यदि कोई नया जारी हुआ है तो ऊपर दिए गए संस्करण स्ट्रिंग को अपडेट करें।

## Asterisk को कंपाइल करना

यदि आपने पहले सॉफ्टवेयर कंपाइल किया है, तो Asterisk को कंपाइल करना एक आसान काम होगा। Asterisk को कंपाइल और इंस्टॉल करने के लिए निम्नलिखित कमांड चलाएँ। याद रखें, आप make menuselect का उपयोग करके चुन सकते हैं कि कौन से एप्लिकेशन और मॉड्यूल का निर्माण करना है। चरण 1: सोर्स कोड डाउनलोड करें
...
चरण 2: बिल्ड पूर्वापेक्षाएँ इंस्टॉल करें (ऊपर "निर्भरताएँ इंस्टॉल करना" देखें)
...
`make install` बाइनरी और मॉड्यूल इंस्टॉल करता है, `make samples` नमूना कॉन्फ़िगरेशन फ़ाइलों को `/etc/asterisk` में लिखता है, `make config` आपके पता लगाए गए वितरण के लिए SysV init स्टार्टअप स्क्रिप्ट इंस्टॉल करता है (जैसे Debian/Ubuntu पर `/etc/init.d/asterisk`), और `ldconfig` साझा-लाइब्रेरी कैश को रिफ्रेश करता है। एक systemd यूनिट भी सोर्स ट्री में `contrib/systemd/asterisk.service` पर आती है, लेकिन `make config` इसे स्वचालित रूप से इंस्टॉल नहीं करता है — यदि आप systemd के तहत Asterisk चलाना पसंद करते हैं तो इसे स्वयं कॉपी करें (नीचे देखें)।

### menuselect के साथ मॉड्यूल चुनना

`make menuselect` एक टेक्स्ट-आधारित मेनू खोलता है जहाँ आप चुनते हैं कि वास्तव में कौन से एप्लिकेशन, codecs, चैनल और संसाधनों का निर्माण करना है। Asterisk 22 के लिए कुछ विशिष्ट नोट्स:

- **chan_pjsip** (*Channel Drivers* के तहत) आधुनिक SIP चैनल है और डिफ़ॉल्ट रूप से सक्षम है; यह Asterisk 22 में एकमात्र SIP चैनल है।
- **codec_opus** (*Codec Translators* के तहत) एक **बाहरी** मॉड्यूल है (इसकी menuselect प्रविष्टि "Download the Opus codec from Digium" पढ़ती है); इसे सक्षम करने से `make` Sangoma/Digium से मुफ्त, क्लोज्ड-सोर्स बाइनरी लाता है। Opus pass-through को स्वयं किसी अतिरिक्त मॉड्यूल की आवश्यकता नहीं है। Sangoma का **codec_g729** मॉड्यूल भी उपलब्ध है — बाइनरी डाउनलोड करने के लिए मुफ्त है, लेकिन वैध G.729 ट्रांसकोडिंग के लिए प्रति-चैनल लाइसेंस खरीदने की आवश्यकता होती है।
- *Core Sound Packages*, *Music On Hold File Packages*, और *Extras Sound Packages* मेनू में वे साउंड फॉर्मेट और भाषाएँ चुनें जिन्हें आप चाहते हैं; आप वहाँ जो कुछ भी चेक करते हैं वह `make install` के दौरान स्वचालित रूप से डाउनलोड और इंस्टॉल हो जाता है।

अपने चयन करने के बाद, **Save & Exit** चुनें और `make` के साथ जारी रखें।

> **[दूसरा संस्करण नोट]** लेखक कार्रवाई: पहले संस्करण के `make menuselect` स्क्रीनशॉट को एक नए Asterisk 22 कैप्चर के साथ बदलें जिसकी Channel Drivers स्क्रीन chan_pjsip दिखाती है और कोई chan_sip/chan_skinny/chan_mgcp नहीं।
...
Asterisk को बंद करने के लिए CLI कमांड stop now का उपयोग करें।
...
आधुनिक Linux वितरणों (Debian 12, Ubuntu 22.04/24.04, Rocky/AlmaLinux 9) पर, सिस्टम सर्विस मैनेजर **systemd** है। Asterisk सोर्स ट्री में `contrib/systemd/asterisk.service` पर एक systemd यूनिट भेजता है; इसे `/etc/systemd/system/asterisk.service` पर कॉपी करें और `systemctl daemon-reload` चलाएँ। एक बार इंस्टॉल हो जाने के बाद, प्रोडक्शन में Asterisk चलाने का अनुशंसित तरीका `systemctl` के माध्यम से है:
...
पुराने सिस्टम पर Asterisk को विरासत SysV init स्क्रिप्ट (`/etc/init.d/asterisk`) और **safe_asterisk** रैपर के माध्यम से शुरू किया गया था, जो क्रैश होने पर Asterisk को स्वचालित रूप से पुनरारंभ करता था। systemd के साथ, स्वचालित पुनरारंभ यूनिट फ़ाइल के `Restart=` निर्देश द्वारा संभाला जाता है, इसलिए `safe_asterisk` की आमतौर पर अब आवश्यकता नहीं है। विरासत init/`safe_asterisk` दृष्टिकोण अभी भी काम करता है लेकिन systemd-आधारित वितरणों पर इसे बहिष्कृत (deprecated) कर दिया गया है।
...
1. Asterisk 22 में, कौन सा चैनल ड्राइवर SIP समर्थन प्रदान करता है, और पुराने `chan_sip` का क्या हुआ?
   ...
   - D. IAX2 के पक्ष में SIP समर्थन पूरी तरह से हटा दिया गया था।
2. Asterisk के लिए टेलीफोनी इंटरफेस कार्ड में आमतौर पर डिजिटल सिग्नल प्रोसेसर (DSPs) निर्मित होते हैं और इसलिए उन्हें PC से बहुत अधिक CPU की आवश्यकता नहीं होती है।
   - A. सही
   - B. गलत
...
4. आपको हमेशा नवीनतम Asterisk संस्करण चुनना चाहिए, क्योंकि यह सबसे स्थिर है।
   - A. सही
   - B. गलत
5. Asterisk 22 के लिए बिल्ड निर्भरताएँ इंस्टॉल करने का अनुशंसित तरीका क्या है?
