...
पहले अध्याय में, हमने टेलीफोनी वातावरण में Asterisk की उपयोगिता के बारे में थोड़ा जाना। इस अध्याय में, हम Asterisk को डाउनलोड और इंस्टॉल करने का तरीका जानेंगे। शुरू करने से पहले, इसे कंपाइल और इंस्टॉल करना सीखना आवश्यक है। कंपाइलेशन की प्रक्रिया पारंपरिक Microsoft™ Windows™ उपयोगकर्ताओं के लिए अजीब लग सकती है, लेकिन Linux™ वातावरण में यह काफी सामान्य है। Asterisk को कंपाइल करते समय आप अपने हार्डवेयर के लिए अनुकूलित (optimized) कोड प्राप्त कर सकते हैं, और हम यहाँ यही करेंगे। Asterisk कई ऑपरेटिंग सिस्टम में चलता है, लेकिन हमने चीजों को आसान रखने के लिए उनमें से केवल एक के साथ शुरुआत करने का निर्णय लिया है: Linux। हमने Linux™ वितरण के रूप में Debian को चुना है क्योंकि इसकी डिपेंडेंसी (dependencies) इंस्टॉल करना आसान है और यह वितरण स्थिर है, जिसका फुटप्रिंट कम है। यदि आप किसी अन्य वितरण का उपयोग करना चाहते हैं, तो कृपया डिपेंडेंसी के नाम तदनुसार बदल लें।

यह संस्करण **Asterisk 22 LTS** को लक्षित करता है (रिलीज तिथि 2024-10-16; 2028-10-16 तक पूर्ण समर्थन, 2029-10-16 तक सुरक्षा फिक्स)। Asterisk 22 वर्तमान लॉन्ग-टर्म सपोर्ट रिलीज है। ध्यान दें कि Digium का अधिग्रहण 2018 में **Sangoma** द्वारा किया गया था, और Asterisk अब Sangoma द्वारा प्रायोजित है — इस पूरे अध्याय में "Digium" के संदर्भ पुराने हार्डवेयर के लिए लीगेसी ब्रांड को दर्शाते हैं।
...
- पंजीकृत उपयोगकर्ताओं की कुल संख्या। निर्धारित करें कि आपको प्रति सेकंड कितने पंजीकरणों का समर्थन करने की आवश्यकता है।
- एक साथ होने वाली कॉल्स की कुल संख्या। निर्धारित करें कि आपको Asterisk सर्वर पर नेटवर्क एडेप्टर और ब्रिज में कितनी नेटवर्क बातचीत को प्रोसेस करने की आवश्यकता है।
- आपको किन codecs का समर्थन करने की आवश्यकता है। उच्च जटिलता वाले codecs को आपके सर्वर में बहुत अधिक CPU/FPU पावर की आवश्यकता होगी; उदाहरण के लिए, iLBC को इसके निर्माता (Global IP Sound) द्वारा TI C54x DSP पर 30 ms फ्रेम के लिए लगभग 18 MIPS प्रति चैनल (और 20 ms फ्रेम के लिए लगभग 15 MIPS) मापा गया था।
...
- हार्ड डिस्क पर पूरा ध्यान दें, PBX का उपयोग 24x7 शासन में किया जाता है जबकि डेस्कटॉप 8x5 काम करते हैं। PBX के लिए डेस्कटॉप हार्डवेयर का उपयोग न करें, आमतौर पर हार्ड डिस्क पहले वर्ष से पहले ही विफल हो जाती है। मेरी सिफारिश है कि एक सर्वर मशीन या 24x7 एप्लिकेशन चलाने के लिए डिज़ाइन किए गए उपकरण का उपयोग करें।

### IRQ शेयरिंग

टेलीफोनी इंटरफेस कार्ड (जैसे, X100P) बड़ी मात्रा में इंटरप्शन उत्पन्न करते हैं। इन इंटरप्शन को पूरा करने के लिए प्रोसेसर समय की आवश्यकता होती है। यदि आपके पास कोई अन्य डिवाइस उसी इंटरप्शन का उपयोग कर रहा है तो ड्राइवर यह प्रोसेसिंग नहीं कर सकते। एक सिंगल CPU सिस्टम में, आपको डिवाइसों के बीच IRQ शेयरिंग से बचना चाहिए। हम Asterisk चलाने के लिए समर्पित हार्डवेयर के उपयोग की सलाह देते हैं। किसी भी बाहरी या अनावश्यक हार्डवेयर को अक्षम करना न भूलें। कुछ हार्डवेयर को मदरबोर्ड BIOS सेटअप में अक्षम किया जा सकता है। एक बार जब आप अपना कंप्यूटर शुरू कर लेते हैं, तो /proc/interrupts में अपने असाइन किए गए इंटरप्ट्स देखें।
...
Asterisk इंस्टॉल करने के तुरंत बाद, हम Asterisk और DAHDI ड्राइवरों के बाद के संकलन के लिए आवश्यक पैकेज इंस्टॉल करेंगे। सबसे पहले, हम Debian को बताएंगे कि पैकेज कहाँ से डाउनलोड किए जाएंगे। यह apt-setup उपयोगिता का उपयोग करके किया जाता है। चरण 1: वर्चुअल मशीन में Ubuntu 24.04 LTS सर्वर इंस्टॉल करें (64-बिट इमेज का उपयोग करें; इस पुस्तक में उपयोग किए गए वितरण 64-बिट हैं, हालाँकि Asterisk स्वयं अभी भी 32-बिट x86 का समर्थन करता है)। हमने इस प्रशिक्षण के लिए VirtualBox का उपयोग किया है। आप https://releases.ubuntu.com/24.04 से इमेज डाउनलोड कर सकते हैं। Linux इंस्टॉलेशन इस प्रशिक्षण के दायरे से बाहर है। Linux का बुनियादी ज्ञान इस प्रशिक्षण के लिए पूर्वापेक्षा है।

## Asterisk के लिए Linux इंस्टॉल करना

अपने Linux को सामान्य रूप से इंस्टॉल करें, बिना ग्राफिकल यूजर इंटरफेस के। ईमेल सर्वर को भी इंस्टॉल और कॉन्फ़िगर करें। इस पुस्तक में बाद में वॉइसमेल नोटिफिकेशन भेजने के लिए हमें ईमेल सर्वर (exim4) की आवश्यकता होगी। सावधानी: यह इंस्टॉलेशन आपके PC को फॉर्मेट कर देगा। आपका सारा डिस्क डेटा मिटा दिया जाएगा। कृपया सुनिश्चित करें कि शुरू करने से पहले सभी डेटा का बैकअप ले लें। चरण 1: CD को CD-ROM ड्राइव में डालें और अपने PC को बूट करें। अधिकांश प्रश्नों के उत्तर देना बहुत सरल है।

## डिपेंडेंसी इंस्टॉल करना

Asterisk और DAHDI इंस्टॉल करने के लिए आपको कई सॉफ्टवेयर डिपेंडेंसी इंस्टॉल करनी होंगी। Asterisk 22 में ऐसा करने का अनुशंसित तरीका सोर्स ट्री के साथ आने वाली स्क्रिप्ट का उपयोग करना है, जो प्रत्येक समर्थित वितरण के लिए सही पैकेज नाम जानती है। Asterisk सोर्स को डाउनलोड और एक्सट्रैक्ट करने के बाद (नीचे "Asterisk को कंपाइल करना" देखें), चलाएं:
...
चरण 1: root के रूप में लॉगिन करें (या `sudo` का उपयोग करें)। चरण 2: यदि आप Debian/Ubuntu सिस्टम पर मैन्युअल रूप से डिपेंडेंसी इंस्टॉल करना पसंद करते हैं, तो समकक्ष पैकेज सूची है:
...
ध्यान दें कि Asterisk सोर्स अब Git पर होस्ट किया गया है, इसलिए `subversion` की अब आवश्यकता नहीं है, और आधुनिक Debian/Ubuntu वर्शन्ड `libncurses5-dev` के बजाय `libncurses-dev` शिप करते हैं। हाथ से बनाए गए सूची के बजाय `./contrib/scripts/install_prereq install` को प्राथमिकता दें, क्योंकि स्क्रिप्ट हमेशा आपके वितरण के लिए सही पैकेज नामों को ट्रैक करती है।

### DAHDI

DAHDI (Digium/Sangoma Asterisk Hardware Device Interface) एनालॉग और डिजिटल कार्ड के लिए ड्राइवरों का आर्किटेक्चर है। Asterisk इंस्टॉल करने से पहले, यदि आप एनालॉग या डिजिटल इंटरफेस का उपयोग करने की योजना बना रहे हैं, तो DAHDI इंस्टॉल करना महत्वपूर्ण है। DAHDI अभी भी एनालॉग/डिजिटल टेलीफोनी कार्ड के लिए मौजूद है लेकिन तेजी से विशिष्ट होता जा रहा है — अधिकांश आधुनिक परिनियोजन शुद्ध VoIP हैं और इस अनुभाग को पूरी तरह से छोड़ सकते हैं। DAHDI केवल तभी इंस्टॉल करें यदि आपके पास भौतिक टेलीफोनी इंटरफेस हार्डवेयर है। सोर्स फ़ाइलें प्राप्त करें:

```
wget https://downloads.asterisk.org/pub/telephony/dahdi-linux-complete/dahdi-linux-complete-current.tar.gz
```

फ़ाइलों को अनकंप्रेस करें:
...
आपको DAHDI मॉड्यूल को कंपाइल करने की आवश्यकता होगी। ./configure और make menuselect कमांड कई साल पहले पेश किए गए थे। बाद वाला आपको यह चुनने में सक्षम बनाता है कि कौन सी उपयोगिताओं और मॉड्यूल का निर्माण करना है। निम्नलिखित कमांड ऐसा करेंगे:
...
make install-config DAHDI को कॉन्फ़िगर कर दिया गया है। यदि आपके पास कोई DAHDI हार्डवेयर है, तो अब यह अनुशंसा की जाती है कि आप /etc/dahdi/modules को संपादित करें ताकि केवल इस सिस्टम में इंस्टॉल किए गए DAHDI हार्डवेयर के लिए समर्थन लोड हो सके। डिफ़ॉल्ट रूप से, सभी DAHDI हार्डवेयर के लिए समर्थन DAHDI स्टार्ट पर लोड हो जाता है। मुझे लगता है कि आपके सिस्टम पर मौजूद DAHDI हार्डवेयर है: usb:004/002 xpp_usb- e4e4:1150 Astribank-multi no-firmware यह स्क्रीन (ऊपर) आपसे फ़ाइल /etc/dahdi/modules को बदलने के लिए कहती है ताकि केवल आपके विशिष्ट कॉन्फ़िगरेशन के लिए आवश्यक ड्राइवर लोड हों और पता चला हार्डवेयर दिखाई दे। फ़ाइल /etc/dahdi/modules को संपादित करें और केवल आवश्यक हार्डवेयर लोड करें। मेरे मामले में, मैं Xorcom Astribank 6FXS और 2FXO के साथ एक टेस्ट मशीन का उपयोग कर रहा था। फ़ाइल नीचे दिखाई गई है।
...
अंगूठे के नियम के रूप में, आपको आवश्यक सुविधाओं वाले संस्करण का उपयोग करना चाहिए। Asterisk वैकल्पिक LTS (लॉन्ग-टर्म सपोर्ट) और मानक रिलीज के रिलीज मॉडल का पालन करता है। इस संस्करण के समय, **Asterisk 22 वर्तमान LTS रिलीज है** (अक्टूबर 2024 में जारी; नवीनतम पॉइंट रिलीज 22.10.0 है), जो इसे अभी चुनने के लिए सबसे अच्छा बनाता है। Asterisk 20 पिछला LTS है, और संस्करण 16 (पहले संस्करण में उपयोग किया गया) का जीवनकाल समाप्त हो चुका है। प्रोडक्शन सिस्टम के लिए, हमेशा LTS रिलीज चुनें।

## Asterisk को कंपाइल करना

यदि आपने पहले सॉफ्टवेयर कंपाइल किया है, तो Asterisk को कंपाइल करना एक आसान काम होगा। Asterisk को कंपाइल और इंस्टॉल करने के लिए निम्नलिखित कमांड चलाएं। याद रखें, आप make menuselect का उपयोग करके चुन सकते हैं कि किन एप्लिकेशनों और मॉड्यूल का निर्माण करना है। चरण 1: सोर्स कोड डाउनलोड करें
...
चरण 4: निर्माण के लिए मॉड्यूल चुनें

```
make menuselect
```

केवल आवश्यक मॉड्यूल इंस्टॉल करने के लिए make menuselect का उपयोग करें। Asterisk 22 में SIP चैनल **chan_pjsip** है (डिफ़ॉल्ट रूप से निर्मित); पुराना **chan_sip** Asterisk 21 में हटा दिया गया था और अब मौजूद नहीं है। Opus *pass-through* बॉक्स के बाहर काम करता है (इन-ट्री `res_format_attr_opus` मॉड्यूल SDP वार्ता को संभालता है), लेकिन **codec_opus** ट्रांसकोडिंग मॉड्यूल अभी भी Sangoma/Digium से एक बाहरी, क्लोज्ड-सोर्स बाइनरी है — menuselect में इसे चुनने से यह Digium के सर्वर से डाउनलोड हो जाता है। बाइनरी निःशुल्क है। विवरण के लिए नीचे "menuselect के साथ मॉड्यूल चुनना" देखें।

चरण 5: Asterisk का निर्माण और इंस्टॉलेशन करें, फिर डिफ़ॉल्ट कॉन्फ़िगरेशन और नमूना फ़ाइलें बनाएं
...
`make install` बाइनरी और मॉड्यूल इंस्टॉल करता है, `make samples` नमूना कॉन्फ़िगरेशन फ़ाइलों को `/etc/asterisk` में लिखता है, `make config` आपके पता लगाए गए वितरण के लिए SysV init स्टार्टअप स्क्रिप्ट इंस्टॉल करता है (उदा. Debian/Ubuntu पर `/etc/init.d/asterisk`), और `ldconfig` साझा-लाइब्रेरी कैश को रिफ्रेश करता है। एक systemd यूनिट भी सोर्स ट्री में `contrib/systemd/asterisk.service` पर शिप होती है, लेकिन `make config` इसे स्वचालित रूप से इंस्टॉल नहीं करता है — यदि आप systemd के तहत Asterisk चलाना पसंद करते हैं तो इसे स्वयं कॉपी करें (नीचे देखें)।

### menuselect के साथ मॉड्यूल चुनना

`make menuselect` एक टेक्स्ट-आधारित मेनू खोलता है जहाँ आप चुनते हैं कि वास्तव में किन एप्लिकेशनों, codecs, चैनलों और संसाधनों का निर्माण करना है। Asterisk 22 के लिए कुछ विशिष्ट नोट्स:

- **chan_pjsip** (*Channel Drivers* के तहत) आधुनिक SIP चैनल है और डिफ़ॉल्ट रूप से सक्षम है; यह Asterisk 22 में एकमात्र SIP चैनल है।
- **codec_opus** (*Codec Translators* के तहत) एक **बाहरी** मॉड्यूल है (इसकी menuselect प्रविष्टि "Download the Opus codec from Digium" पढ़ती है); इसे सक्षम करने से `make` Sangoma/Digium से निःशुल्क, क्लोज्ड-सोर्स बाइनरी प्राप्त करता है। Opus pass-through को स्वयं किसी अतिरिक्त मॉड्यूल की आवश्यकता नहीं है। Sangoma का **codec_g729** मॉड्यूल भी उपलब्ध है — बाइनरी डाउनलोड करने के लिए निःशुल्क है, लेकिन वैध G.729 ट्रांसकोडिंग के लिए खरीदे गए प्रति-चैनल लाइसेंस की आवश्यकता होती है।
- *Core Sound Packages*, *Music On Hold File Packages*, और *Extras Sound Packages* मेनू में वे साउंड फॉर्मेट और भाषाएं चुनें जिन्हें आप चाहते हैं; वहाँ आप जो कुछ भी चेक करते हैं वह `make install` के दौरान स्वचालित रूप से डाउनलोड और इंस्टॉल हो जाता है।
...
आधुनिक Linux वितरणों (Debian 12, Ubuntu 22.04/24.04, Rocky/AlmaLinux 9) पर, सिस्टम सर्विस मैनेजर **systemd** है। Asterisk सोर्स ट्री में `contrib/systemd/asterisk.service` पर एक systemd यूनिट शिप करता है; इसे `/etc/systemd/system/asterisk.service` पर कॉपी करें और `systemctl daemon-reload` चलाएं। एक बार इंस्टॉल हो जाने के बाद, प्रोडक्शन में Asterisk चलाने का अनुशंसित तरीका `systemctl` के माध्यम से है:
...
एक बार जब Asterisk एक सेवा के रूप में चल रहा हो, तो इसके CLI से `asterisk -r` (कनेक्ट) या `asterisk -rvvv` (वर्बोज़ आउटपुट के साथ कनेक्ट) के साथ जुड़ें।

पुराने सिस्टम पर Asterisk को लीगेसी SysV init स्क्रिप्ट (`/etc/init.d/asterisk`) और **safe_asterisk** रैपर के माध्यम से शुरू किया गया था, जो क्रैश होने पर Asterisk को स्वचालित रूप से पुनरारंभ करता था। systemd के साथ, स्वचालित पुनरारंभ यूनिट फ़ाइल के `Restart=` निर्देश द्वारा संभाला जाता है, इसलिए `safe_asterisk` की आमतौर पर अब आवश्यकता नहीं है। लीगेसी init/`safe_asterisk` दृष्टिकोण अभी भी काम करता है लेकिन systemd-आधारित वितरणों पर इसे बहिष्कृत (deprecated) कर दिया गया है।
...
आप निम्नलिखित कमांड निष्पादित करके Asterisk कंसोल तक पहुंच सकते हैं। कृपया ध्यान दें कि एक ही समय में एक से अधिक कंसोल प्रक्रियाएं चलाई जा सकती हैं।
...
## इंस्टॉलेशन निर्देशिकाएं

Asterisk कई निर्देशिकाओं में इंस्टॉल होता है, जिन्हें asterisk.conf फ़ाइल में संशोधित किया जा सकता है। प्रशिक्षण उद्देश्यों के लिए मैं वर्बोज़ को 3 से 15 में बदल दूँगा, प्रोडक्शन के लिए इसे 3 में रखें। max_calls और max_load विकल्प आपके सिस्टम को ओवरलोडिंग से बचाने के लिए अच्छे विकल्प हैं।
...
logrotate के बारे में अधिक जानकारी का उपयोग करके प्राप्त की जा सकती है:
...
- वॉयस नेटवर्क के अनावश्यक प्रसारण को अलग करने के लिए VLANs का उपयोग करें। आप नहीं चाहेंगे कि कोई वायरस ARP प्रसारण के साथ आपके वॉयस नेटवर्क को नष्ट कर दे।
- वॉयस नेटवर्क में अपेक्षाओं के बारे में उपयोगकर्ताओं को शिक्षित करें। QoS के बिना, यह न कहें कि वॉयस एकदम सही होगी क्योंकि अधिकांश मामलों में ऐसा नहीं होगा। मोबाइल फोन के समान वॉयस क्वालिटी अक्सर प्राप्त की जाएगी। गुणवत्तापूर्ण फोन का उपयोग करें क्योंकि फर्मवेयर और हार्डवेयर डिज़ाइन के साथ समस्याएं आम हैं।
...
1. Asterisk 22 में, कौन सा चैनल ड्राइवर SIP समर्थन प्रदान करता है, और पुराने `chan_sip` का क्या हुआ?
   ...
   - C. दोनों डिफ़ॉल्ट रूप से निर्मित हैं और आप रनटाइम पर उनके बीच चयन करते हैं।
   - D. SIP समर्थन को पूरी तरह से IAX2 के पक्ष में हटा दिया गया था।
2. Asterisk के लिए टेलीफोनी इंटरफेस कार्ड में आमतौर पर डिजिटल सिग्नल प्रोसेसर (DSPs) इन-बिल्ट होते हैं और इसलिए उन्हें PC से अधिक CPU की आवश्यकता नहीं होती है।
   - A. सही
   - B. गलत
...
6. यदि आपके पास TDM इंटरफेस कार्ड नहीं है, तो भी आपके पास सिंक्रोनाइज़ेशन के लिए एक आंतरिक टाइमिंग स्रोत होगा, जो Linux पर `res_timing_timerfd` मॉड्यूल द्वारा प्रदान किया जाता है। इस टाइमिंग का उपयोग ________ और ________ जैसे एप्लिकेशनों द्वारा किया जाता है।
7. Asterisk इंस्टॉल करते समय GNOME या KDE जैसे डेस्कटॉप वातावरण को छोड़ना बेहतर है, क्योंकि ग्राफिकल इंटरफेस CPU चक्रों की खपत करते हैं।
   - A. सही
   - B. गलत
8. Asterisk कॉन्फ़िगरेशन फ़ाइलें ________ निर्देशिका में स्थित हैं।
9. Asterisk नमूना कॉन्फ़िगरेशन फ़ाइलें इंस्टॉल करने के लिए, कमांड टाइप करें: ________
