...
para breves trechos usados em resenhas publicadas.

**Edição:** Segunda Edição.
**ISBN:** *a ser atribuído.*

> **[2nd-ed note]** Atribua um **novo ISBN** para a 2ª edição — não reutilize o
> ISBN da 1ª edição (9781796396973). Defina a data de publicação aqui também.
...
o autor tinha conhecimento de uma reivindicação de marca registrada, elas foram impressas em letras maiúsculas ou com iniciais
maiúsculas. Asterisk, Digium, IAX e DUNDi são marcas registradas da Sangoma Technologies (a Digium
foi adquirida pela Sangoma em 2018; o Asterisk agora é patrocinado pela Sangoma).
...
Branch Exchange) baseado no Asterisk 22 LTS. O Asterisk é uma plataforma de telefonia open source
que conecta VoIP e canais TDM tradicionais.

Esta é a quinta geração de um livro que começou como o *Asterisk Configuration
Guide*. O material surgiu do trabalho que fiz para me preparar para a certificação
Digium dCAP em 2006 — a qual passei na primeira tentativa — e tem sido
ensinado a mais de mil alunos desde então.

O conceito de PBX open source é revolucionário. Por décadas, a telefonia foi dominada por
...
automática de chamadas), voicemail e muito mais — agora estão disponíveis para qualquer pessoa com uma
...
tem um complemento — laboratórios práticos e um curso online — na **VoIP School Blackbelt**
(<https://voip.school>).
...
- **PJSIP é o único canal SIP.** `chan_sip` foi removido no Asterisk 21 e não
  existe no 22. Todo exemplo de SIP agora usa PJSIP (`pjsip.conf`); o material legado do `sip.conf`
  é mantido apenas como referência de migração.
- **Gestão da Sangoma.** A Digium foi adquirida pela Sangoma em 2018; o projeto agora é
...
software open source porque acredita que a maneira estruturada como as certificações ensinavam
...
## Feedback, créditos & treinamento {.unnumbered}

Eu me esforço muito para encontrar e eliminar erros, mas alguns sempre escapam. Se você encontrar
...
**Créditos.** Arte da capa: Karla Braga. Revisores: Luis F. Gonçalves, Guilherme Goes
