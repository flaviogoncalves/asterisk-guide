...
IAX2 is a legacy protocol (see the *Legacy channels* chapter), and the SipPulse Softphone is SIP-only, so it cannot register an IAX account. If you need to test IAX2, use a softphone that still supports it. Create a new IAX account,
